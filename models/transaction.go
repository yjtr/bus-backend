...
type Transaction struct {
	...
	EndStation    uint      `gorm:"index" json:"end_station"`                    // 下车站点ID
	...
	AlightTime    *time.Time `gorm:"index" json:"alight_time"`                  // 下车时间（NULL表示未下车）
	...
	Status        string    `gorm:"size:20;default:'completed'" json:"status"`   // 状态：completed, pending, cancelled
